...
def logincolaborador():
	...
	navegador.get("https://eadinfinity/colaborador/")

	time.sleep(1)

	navegador.find_element_by_xpath('/html/body/div[2]/div/div/div/div/div/div[4]/form/div[1]/input').send_keys("ead@eadinfinity")

	navegador.find_element_by_xpath('/html/body/div[2]/div/div/div/div/div/div[4]/form/div[2]/input').send_keys("11111")
